...
NBModel = joblib.load(r"GRU and NB/NaiveBayesModel.pkl")
NBVectorizer = joblib.load(r"GRU and NB/NaiveBayesVectorizer.pkl")
GRUModel = load_model(r"GRU and NB/GRUModelEmail.h5")
tokenizer = joblib.load(r"GRU and NB/tokenizer.pkl")
